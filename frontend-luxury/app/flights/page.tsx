        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h1 className="font-display text-5xl md:text-6xl font-bold mb-4">
              Book Your <span className="text-white">Private Flight</span>
            </h1>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          ...
                          <div className="text-3xl font-bold text-white">${(flight.price || 0).toLocaleString()}</div>
                        </div>
            ...
            {!bookingSuccess ? (
              <>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-3xl font-bold text-white">${(selectedFlight.price || 0).toLocaleString()}</p>
                    ...
                    {PAYMENT_METHODS.map((method) => (
                      <button
                        ...
                        className={`glass-card p-4 rounded-lg text-center transition-all ${
                          selectedPayment === method.id ? 'ring-2 ring-[rgb(var(--accent))] bg-[rgba(var(--accent),0.10)]' : 'hover:bg-white/5'
                        }`}
                      >
              ...
              <>
                <h2 className="font-display text-2xl font-bold mb-4 text-white">Booking Confirmed!</h2>
                <div className="space-y-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-white">${(bookingSuccess.totalPrice || 0).toLocaleString()}</p>
                  </div>
                  <div className="glass-card p-4 rounded-lg">
                    <p className="text-sm text-muted mb-2">Next Steps:</p>
                    <ol className="text-sm space-y-1 list-decimal list-inside">
                      <li>Proceed to checkout</li>
                      <li>Generate the payment wallet address</li>
                      <li>Submit your transaction hash for confirmation</li>
                    </ol>
                  </div>
                </div>
                <Button
